...
import voyager.nove.view.dialog.prenotazioni.DialogModificaPrenotazione;
import voyager.nove.view.dialog.prenotazioni.DialogNuovaPrenotazione;
import voyager.nove.view.utils.TabellaPrenotazioni;

/**
 * @name BoundaryGestionePrenotazioni
 *
 * @project Voyager
 *
 * @package voyager.nove.view
 ...
 *
 */
public class BoundaryGestionePrenotazioni extends JPanel{
	
	private static final long serialVersionUID = 1L;
	
	private static final String TITOLO = "Gestione Prenotazioni";
	
	private static final String QUERY_KEY[] = {"Id Prenotazione", "Id Offerta", "Acquirente", "Posti Prenotati"};
	...
	private void buildFrame() {
		...
		//Panel Table
		this.tabellaPrenotazioni = new TabellaPrenotazioni(this.controllerGestionePrenotazioni.getPrenotazioni());
	...
	private void aggiornaTabellaPrenotazioni() {
		this.tabellaPrenotazioni.aggiornaTabella(this.controllerGestionePrenotazioni.getPrenotazioni());
	}
	...
	private class NuovoListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			DialogNuovaPrenotazione dialog = new DialogNuovaPrenotazione((JFrame)SwingUtilities.getWindowAncestor(panelMe));
	...
	private class ModificaListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			DialogModificaPrenotazione dialog = new DialogModificaPrenotazione((JFrame)SwingUtilities.getWindowAncestor(panelMe), prenotazioneBean);
			dialog.setVisible(true);
			if (dialog.datiValidi()) {
