...
/**
 * @name DialogModificaPrenotazione
 *
 * @project Voyager
 *
 * @package voyager.nove.view.dialog.prenotazioni
 ...
 *
 */
public class DialogModificaPrenotazione extends JDialog{
	...
	public DialogModificaPrenotazione(JFrame ownerFrame, PrenotazioneBean prenotazioneBean) {
	...
	private void buildDialog() {
		...
		this.textfieldAcquirente.setText(this.prenotazioneBean.getAcquirente());
	...
	private boolean checkSintassiDati() {
		if (this.textfieldAcquirente.getText().isEmpty() || this.textfieldPostiPrenotati.getText().isEmpty()) {
			JOptionPane.showMessageDialog(this, "Oops! Dati Mancanti!", "Modifica Prenotazione", JOptionPane.INFORMATION_MESSAGE);
			return false;
		} else {
			return true;
		}
	...
	private boolean checkSemanticaDati() {
		if (Integer.parseInt(this.textfieldPostiPrenotati.getText().toString()) <= 0) {
			JOptionPane.showMessageDialog(this, "Oops! Dati Inconsistenti!", "Modifica Prenotazione", JOptionPane.INFORMATION_MESSAGE);
			return false;
		} else {
			return true;
		}
