 ...
 *
 */
public class DialogModificaOfferta extends JDialog{
	...
	public DialogModificaOfferta(JFrame ownerFrame, OffertaBean offertaBean) {
		super(ownerFrame, "Modifica Offerta", true);
	...
	private void buildDialog() {
		...
		this.dataPartenza = new DateTimePicker(this.offertaBean.getDataPartenza());
		this.dataArrivo = new DateTimePicker(this.offertaBean.getDataArrivo());
		this.textfieldPostiDisponibili = new JTextField("", 4);
		this.textfieldPostiDisponibili.setText(String.valueOf(this.offertaBean.getPostiDisponibili()));
	...
	private class ViaggioSelezionatoListener implements ListSelectionListener {
		...
		public void valueChanged(ListSelectionEvent event) {
			offertaBean.setIdViaggio(tabellaViaggi.getViaggioSelezionato().getId());
		}
	...
	private boolean checkSintassiDati() {
		if (this.textfieldPostiDisponibili.getText().isEmpty()) {
			JOptionPane.showMessageDialog(this, "Oops! Dati Mancanti!", "Modifica Offerta", JOptionPane.INFORMATION_MESSAGE);
			return false;
		} else {
			return true;
		}
	...
	private boolean checkSemanticaDati() {
		if (this.dataArrivo.getDate().equals(this.dataPartenza.getDate())
			...
			JOptionPane.showMessageDialog(this, "Oops! Dati Inconsistenti!", "Modifica Offerta", JOptionPane.INFORMATION_MESSAGE);
			return false;
		} else {
			return true;
		}
